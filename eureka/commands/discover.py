    ...
    if llm is not None and candidates:
        ...
        for candidate in candidates:
            ...
            prompt = (
                ...
                "\n"
                "The synthesis — the 'so what' that only becomes visible when all the atoms are in view. "
                "Do NOT reference, quote, or wikilink the atoms. Do NOT summarize them. "
                "Write the standalone insight as if the reader has never seen the atoms. "
                "2 paragraphs, plain prose, no lists.\n"
                "\n"
                "eli5: One vivid sentence a 10-year-old would understand. Use a concrete metaphor or image, not abstract language.\n"
                "```\n\n"
                "Rules:\n"
                "- Title must be a SHORT claim (under 80 chars).\n"
                "- Body should be 2 paragraphs, 4-8 sentences total.\n"
                "- NO wikilinks, NO [[brackets]], NO atom references in the body. The molecule stands alone.\n"
